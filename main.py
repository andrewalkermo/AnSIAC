...
def get_classes():
  ...
  # Successful login, access the desired link
  ...
  if response.status_code == 200:
      # Successful access to the desired link
...
def get_semester():
    ...
    # Determine the year and the semester
    year = current_date.year
    semester = None

    # Define the start and end dates for each semester (modify these as needed)
